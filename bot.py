...
အရှိန် - spam speed(0.1sec - 10sec)
ခွင့်လွှတ်လိုက် - stop all spam
ဘာသာပြန် - translate(reply)
file - Broadcast(reply)
အကူညီ - show this help
        ...
        # -------- CHATLIST --------
        if text == "Chatlist" and is_admin_or_owner(user_id, data["BOT_ADMINS"]):
            await message.delete()
            msg = "<b>📡 Connected Groups</b>\n\n"
            for gid in data["GP_CHAT_IDS"]:
                try:
